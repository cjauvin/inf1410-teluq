...
{{< image src="montreal.jpg" alt="Le centre-ville de Montréal vu du mont Royal" title="" loading="lazy" >}}
...
{{< image src="complexité.webp" alt="Diptyque opposant la complexité accidentelle, figurée par un enchevêtrement de câbles étiquetés dette technique, sur-ingénierie, bureaucratie et fonctionnalité désuète, à la complexité essentielle, figurée par un système ordonné autour d'un algorithme central relié aux besoins utilisateurs et aux exigences système" title="Complexité accidentelle et essentielle" loading="lazy" >}}
