...
- **Défense au tableau blanc** (Mitchell Hashimoto, 2026)&nbsp;: critère d'un usage responsable de l'IA, pouvoir à tout moment expliquer comment fonctionne un système qu'on a livré et défendre les décisions prises, sans connaître le code ligne par ligne → [Accueil]({{< ref "/" >}}), [Travaux notés, L'entretien de suivi]({{< ref "/docs/travaux-notés" >}})
