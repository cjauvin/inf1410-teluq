...
nom, et la section sur [la concurrence]({{< relref "/docs/module2/concurrence/40-ne-pas-partager" >}}) montre pourquoi une valeur qu'on ne modifie jamais peut être partagée sans
