...
/* Sur les écrans de moins de 768px (tablettes et téléphones) */
@media (max-width: 768px) {
  ...
  .nav {
    display: none; /* on masque la navigation horizontale */
  }
